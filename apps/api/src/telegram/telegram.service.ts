...
export class TelegramService {
  handleWebhook(body: TelegramWebhookDto): { status: string; body: TelegramWebhookDto } {
  ...
  async miniAppAuth(telegramId: string, payload: Record<string, any>): Promise<{ success: boolean; telegramId: string }> {
